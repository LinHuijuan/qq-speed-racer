...
await page.screenshot({ path: `${outDir}/12-finish-panel.png` });
console.log(`${outDir}/12-finish-panel.png`);
...
await page.waitForTimeout(400);
await page.screenshot({ path: `${outDir}/13-pause-panel.png` });
console.log(`${outDir}/13-pause-panel.png`);
